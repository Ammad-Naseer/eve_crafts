...
import 'screens/user_profile/my_orders_screen.dart';
import 'screens/user_profile/my_listings_screen.dart';
import 'screens/shopping_cart/shopping_cart_screen.dart';
import 'screens/shopping_cart/checkout_screen.dart';
...
final Map<String, WidgetBuilder> routes = {
  ...
  '/productListing': (BuildContext context) => const ProductListingScreen(),
  ...
  '/myListings': (BuildContext context) => const MyListingsScreen(),
  '/shoppingCart': (BuildContext context) => const ShoppingCartScreen(),
